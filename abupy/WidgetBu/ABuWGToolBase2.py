...
from ..WidgetBu.ABuWGBase2 import WidgetBase2, show_msg_func
from ..WidgetBu.ABuWGBSymbol import WidgetSymbolChoice
from ..WidgetBu.ABuWGBRunBase2 import WidgetEnvSetMixin2, WidgetTimeModeMixin2
...
class WidgetToolSet2(WidgetBase2, WidgetEnvSetMixin2, WidgetTimeModeMixin2):
    """基础设置界面"""
    ...
    def __init__(self):
        ...
        self.sc = WidgetSymbolChoice() #股票池设置。
...
class WidgetToolBase2(WidgetBase2):
    """技术分析基类"""
    ...
    def __init__(self, tool_set):
        """
            ...
            description_layout
        """
        if not isinstance(tool_set, WidgetToolSet2):
            raise TypeError('tool_set must isinstance WidgetToolSet2, not {}!'.format(type(tool_set)))
