...
from ..WidgetBu.ABuWGToolBase2 import WidgetToolBase2, single_fetch_symbol_analyse
...
class WidgetTLTool2(WidgetToolBase2):
    """技术分析界面"""
    ...
    def __init__(self, tool_set):
        """初始化技术分析界面"""
        super(WidgetTLTool2, self).__init__(tool_set)
