...
class WidgetFactorBase2(six.with_metaclass(ABCMeta, WidgetBase2)):
    """策略可视化基础类"""
...
class WidgetFactorManagerBase2(six.with_metaclass(ABCMeta, WidgetBase2)):
    """策略管理可视化基础类"""
...
class WidgetSearchBox2(WidgetBase2):
    """搜索框ui界面"""
